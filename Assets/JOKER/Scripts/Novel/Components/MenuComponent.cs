 ...
 */
	...
	public class SavesnapComponent:AbstractComponent
	{
		...
		public override void start ()
		{
			...
			gameManager.saveManager.save("savesnap",true);
			this.gameManager.nextOrder ();
		}
 ...
 */
	...
	public class SleepgameComponent:AbstractComponent
	{
		...
		public override void start ()
		{
			...
			gameManager.saveManager.save("gametmp",true); //一時領域に退避させる。これはawakeのタイミングで戻ってくるために使う。
			gameManager.saveManager.save("savesnap",true); //セーブ用のスナップも同じタイミングで作る
