...
public class note : MonoBehaviour {
	...
	void Update () {
        ...
        GameObject deadlyNote1 = GameObject.Find("deadlyNote1");
        deadlyNote1.transform.position += new Vector3(0.1f, 0, 0);
        GameObject deadlyNote2 = GameObject.Find("deadlyNote2");
        deadlyNote2.transform.position += new Vector3(0.15f, 0, 0);
        GameObject deadlyNote3 = GameObject.Find("deadlyNote3");
        deadlyNote3.transform.position += new Vector3(0.15f, 0, 0);
        GameObject deadlyNote4 = GameObject.Find("deadlyNote4");
